...
bool ModeAcroThrst::init(bool ignore_checks)
{
...
void ModeAcroThrst::air_mode_aux_changed()
{
    disable_air_mode_reset = true;
}

float ModeAcroThrst::throttle_hover() const
{
...
void ModeAcroThrst::get_pilot_desired_angle_rates(float roll_in, float pitch_in, float yaw_in, float &roll_out, float &pitch_out, float &yaw_out)
{
    float rate_limit;
